...
peano_l : ∀ {m : ℕ} → suc m ≢ zero -- helper: left peano
peano_l = λ ()
...
<-trichotomy zero zero = is-≡ refl (¬n<n zero) (¬n<n zero)
<-trichotomy zero (suc n) = is-< z<s peano λ ()
<-trichotomy (suc m) zero = is-> z<s peano_l λ ()
<-trichotomy (suc m) (suc n) with <-trichotomy m n
... | is-< m<n ¬m≡n ¬n<m = is-< (s<s m<n) (λ {refl → ¬-elim ¬n<m m<n}) (λ {(s<s x) → ¬-elim ¬n<m x})
... | is-≡ m≡n ¬m<n ¬n<m = is-≡ (cong suc m≡n) (λ {(s<s x) → ¬-elim ¬m<n x}) (λ {(s<s x) → ¬-elim ¬n<m x})
... | is-> n<m ¬m≡n ¬m<n = is-> (s<s n<m) (λ {refl → ¬-elim ¬m<n n<m}) (λ {(s<s x) → ¬-elim ¬m<n x})
